   ...
   var toIconNode = function (icon) {
      var extraStyle = function () {
         ...
         {case "None": return _U.list([$Styles.BackgroundColor($Styles.Grey)]);
            case "Chicken": return _U.list([$Styles.BackgroundImage("images/chicken-icon.png"),$Styles.BackgroundSize($Styles.Cover)]);
            default: return _U.list([$Styles.BackgroundImage("images/burrito.png"),$Styles.BackgroundSize($Styles.Cover)]);}
      }();
      return A2($Styles.withStyles,
