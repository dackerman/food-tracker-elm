...
Elm.Styles.make = function (_elm) {
   ...
   var elevationStr = function (dist) {
      ...
      "0px ",
      A2($Basics._op["++"],$Basics.toString(dist),A2($Basics._op["++"],"px ",A2($Basics._op["++"],$Basics.toString(radius),"px rgba(0,0,0,0.2)"))));
   };
   ...
   var spacingStr = function (spacing) {
      var _p1 = spacing;
      if (_p1.ctor === "Px") {
            return A2($Basics._op["++"],$Basics.toString(_p1._0),"px");
         } else {
            return A2($Basics._op["++"],$Basics.toString(_p1._0 * 100),"%");
         }
   };
   var style = function (attr) {
      var _p2 = attr;
      switch (_p2.ctor)
      {case "Padding": return {ctor: "_Tuple2",_0: "padding",_1: spacingStr(_p2._0)};
         case "Margin": return {ctor: "_Tuple2",_0: "margin",_1: spacingStr(_p2._0)};
         case "Flex": return {ctor: "_Tuple2",_0: "display",_1: "flex"};
         case "SpaceBetween": return {ctor: "_Tuple2",_0: "justifyContent",_1: "space-between"};
         case "AlignItems": return {ctor: "_Tuple2",_0: "alignItems",_1: alignStr(_p2._0)};
         case "Grow": return {ctor: "_Tuple2",_0: "flex-grow",_1: $Basics.toString(_p2._0)};
         case "Rounded": return {ctor: "_Tuple2",_0: "border-radius",_1: spacingStr(_p2._0)};
         case "Elevation": return {ctor: "_Tuple2",_0: "box-shadow",_1: elevationStr(_p2._0)};
         case "Width": return {ctor: "_Tuple2",_0: "width",_1: spacingStr(_p2._0)};
         case "Height": return {ctor: "_Tuple2",_0: "height",_1: spacingStr(_p2._0)};
         default: return {ctor: "_Tuple2",_0: "fontSize",_1: spacingStr(_p2._0)};}
   };
   var render = function (node) {
      var _p3 = node;
      if (_p3.ctor === "Text") {
            if (_p3._0.ctor === "[]") {
                  return $Html.text(_p3._1);
               } else {
                  return A2($Html.div,_U.list([hStyle(A2($List.map,style,_p3._0))]),_U.list([$Html.text(_p3._1)]));
               }
         } else {
            return A2($Html.div,_U.list([hStyle(A2($List.map,style,_p3._0))]),A2($List.map,render,_p3._1));
         }
   };
   ...
   var withStyle = F2(function (attr,node) {
      var _p4 = node;
      if (_p4.ctor === "Text") {
            return A2(Text,A2($List._op["::"],attr,_p4._0),_p4._1);
         } else {
            return A2(Node,A2($List._op["::"],attr,_p4._0),_p4._1);
         }
   });
   ...
   var AlignItems = function (a) {    return {ctor: "AlignItems",_0: a};};
   var SpaceBetween = {ctor: "SpaceBetween"};
   var Flex = {ctor: "Flex"};
...
Elm.Card.make = function (_elm) {
   ...
   var _op = {};
   var card = function (contents) {
      return A2($Styles.withStyles,
      _U.list([$Styles.Padding($Styles.Px(24)),$Styles.Rounded($Styles.Px(2)),$Styles.Elevation(4),$Styles.Margin($Styles.Px(24))]),
      $Styles.nodes(contents));
   };
...
Elm.Model.make = function (_elm) {
   ...
   var foodCalories = function (food) {
      var _p0 = food;
      if (_p0.ctor === "Ingredient") {
            return _p0._0.calories;
         } else {
            return A3($List.foldl,F2(function (x,y) {    return x + y;}),0,A2($List.map,foodCalories,_p0._0.items));
         }
   };
   var Macro = F3(function (a,b,c) {    return {ctor: "Macro",_0: a,_1: b,_2: c};});
   ...
   var calories = function (foodInstance) {
      ...
      var amount = function () {    var _p2 = food;if (_p2.ctor === "Food") {    return _p2._0.amount;} else {    return _p2._0.amount;}}();
      var proportion = A2(ratio,amount,foodInstance.amount);
   ...
   var Ingredient = function (a) {    return {ctor: "Ingredient",_0: a};};
   var Food = function (a) {    return {ctor: "Food",_0: a};};
   var amount = function (f) {    var _p3 = f;if (_p3.ctor === "Food") {    return _p3._0.amount;} else {    return _p3._0.amount;}};
   var name = function (f) {    var _p4 = f;if (_p4.ctor === "Food") {    return _p4._0.name;} else {    return _p4._0.name;}};
...
Elm.FoodJson = Elm.FoodJson || {};
Elm.FoodJson.make = function (_elm) {
   "use strict";
   _elm.FoodJson = _elm.FoodJson || {};
   if (_elm.FoodJson.values) return _elm.FoodJson.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   var parseAmount = function () {
      var parseTuple = A3($Json$Decode.object2,
      F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
      A2($Json$Decode._op[":="],"amount",$Json$Decode.$float),
      A2($Json$Decode._op[":="],"units",$Json$Decode.string));
      var tryParseAmount = function (_p0) {
         var _p1 = _p0;
         var _p4 = _p1._1;
         var _p3 = _p1._0;
         var _p2 = _p4;
   ...
   var parseCompoundFood = A2($Json$Decode.map,
   C,
   ...
   var parseIngredient = A2($Json$Decode.map,
   I,
   A5($Json$Decode.object4,
   IngredientJson,
   A2($Json$Decode._op[":="],"id",$Json$Decode.$int),
   ...
   var jsonToFoods = $Json$Decode.list($Json$Decode.oneOf(_U.list([parseIngredient,parseCompoundFood])));
...
Elm.Grid.make = function (_elm) {
   ...
   $Styles = Elm.Styles.make(_elm);
   var _op = {};
   var gridCol = function (val) {    return $Styles.nodes(_U.list([$Styles.text(val)]));};
   var gridRow = F2(function (columns,obj) {
      var pct = 1.0 / $Basics.toFloat($List.length(columns));
      return A2($Styles.withStyles,
      _U.list([$Styles.Flex,$Styles.SpaceBetween,$Styles.AlignItems($Styles.Center),$Styles.Height($Styles.Px(48))]),
      $Styles.nodes(A2($List.map,
      function (_p0) {
         var _p1 = _p0;
         return A2($Styles.withStyle,$Styles.Width($Styles.Pct(pct)),gridCol(_p1.fn(obj)));
      },
      columns)));
   });
   var headerRow = function (columns) {
      var pct = 1.0 / $Basics.toFloat($List.length(columns));
      return A2($Styles.withStyles,
      _U.list([$Styles.Flex,$Styles.SpaceBetween,$Styles.AlignItems($Styles.Center),$Styles.Height($Styles.Px(48))]),
      $Styles.nodes(A2($List.map,function (_p2) {    var _p3 = _p2;return A2($Styles.withStyle,$Styles.Width($Styles.Pct(pct)),gridCol(_p3.name));},columns)));
   };
   var grid = F2(function (columns,data) {
      var rows = A2($List._op["::"],headerRow(columns),A2($List.map,gridRow(columns),data));
      return $Styles.nodes(rows);
   });
   var ColumnDef = F2(function (a,b) {    return {name: a,fn: b};});
...
Elm.Main.make = function (_elm) {
   ...
   var foodsList = function (_p0) {
      var _p1 = _p0;
      var columns = _U.list([{name: "Name",fn: function (_p2) {    var _p3 = _p2;return $Model.name(_p3.food);}}
                            ,{name: "Amount",fn: function (_p4) {    var _p5 = _p4;return $Basics.toString($Model.amount(_p5.food));}}
   ...
   foodResults.signal);
   var Not = {ctor: "Not"};
   var chipotleBlackBeans = $Model.Ingredient({name: "Chipotle Black Beans",calories: 70,amount: $Model.Grams(80)});
   var chipotleFajitaVegetables = $Model.Ingredient({name: "Chipotle Fajita Vegetables",calories: 20,amount: $Model.Grams(30)});
   var chipotleChicken = $Model.Ingredient({name: "Chipotle Chicken",calories: 160,amount: $Model.Grams(100)});
   var burritoBowl = $Model.Food({name: "Burrito Bowl",amount: $Model.Ounces(8),items: _U.list([chipotleChicken,chipotleFajitaVegetables,chipotleBlackBeans])});
   var chickenBreast = $Model.Ingredient({name: "Chicken Breast",calories: 1,amount: $Model.Grams(50)});
   var groundBeef = $Model.Ingredient({name: "Ground Beef",calories: 332.1,amount: $Model.Ounces(4)});
   var model = {foods: _U.list([{food: groundBeef,amount: $Model.Ounces(2)}
                               ,{food: chickenBreast,amount: $Model.Grams(100)}
                               ,{food: burritoBowl,amount: $Model.Ounces(8)}])
               ,currentMonth: "March"};
   var main2 = $Styles.render(foodsList(model));
   return _elm.Main.values = {_op: _op
                             ,groundBeef: groundBeef
                             ,chickenBreast: chickenBreast
                             ,chipotleChicken: chipotleChicken
                             ,chipotleFajitaVegetables: chipotleFajitaVegetables
                             ,chipotleBlackBeans: chipotleBlackBeans
                             ,burritoBowl: burritoBowl
                             ,model: model
                             ,Not: Not
